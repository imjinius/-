								...
								<!-- Content -->
									...
									<div class="info-wrapper" id="gong">
										...
										<c:forEach var="gong" items="${gong }">
													<ul class="info-list">
														 <li>
															<a href="./iboardContent.bo?i_num=${gong.i_num }" class="i_list">
																<span><img src="iBoardUpload/t-${gong.image }"></span>
															</a>
														</li> 
													</ul>
										</c:forEach>
														...
														<c:if test="${pageNum != 1 }">
														<a href="iboardList.bo?pageNum=${pageNum-1 }" class="pre">◀</a>
														</c:if>
														<c:if test="${pageNum != pageCount }">
														<a href="iboardList.bo?pageNum=${pageNum+1 }">▶</a>
														</c:if>
														</div>
													<br>
											</div>
