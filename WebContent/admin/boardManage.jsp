					...
					<article class="box post" style="font-size: 16px; margin: 0;">
											...
											<!-- Table -->
													...
													<nav id="nav">
														<ul>
															...
															<li><a id="read" href="./boardAlign.ad?op=readcount">조회수 많은 순▼</a></li>
															<li><a id="reply" href="./boardAlign.ad?op=replycount">댓글 많은 순▼</a></li>
															<li><a id="thumb" href="./boardAlign.ad?op=thumb">좋아요 많은 순▼</a></li>
														</ul>
													</nav>
													</div>
							...
							<span><button type="button" id="del" class="button manage" onclick="deleteBData();">삭제</button></span>
													...
													<c:if test="${result != 0 }">
														...
														<a href="./boardManage.ad?pageNum=${startPage-pageBlock }">◀</a>
														</c:if>
														
														<c:forEach begin="${startPage }" end="${endPage }" step="1" var="i">
														<a href="./boardManage.ad?pageNum=${i }">${i }</a>
														</c:forEach>
